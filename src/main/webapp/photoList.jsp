...
<link href="<%=path %>/css/photolist.css" rel="stylesheet">
<!-- 返回顶部调用 begin -->
...
<div id="mainbody">
  <div class="blogs">
    <div id="index_view" class="plist">
      <h1 class="c_titile"></h1>
      <ul>
	  <s:iterator value="plist" id="pentity">
        <li><a href="<%=path%>/home_viewPhoto?id=<s:property value='p_id'/>"><img src="<%= path%>/miniphoto/list/<s:property value='path'/>"></a></li>
      </s:iterator>
      </ul>
