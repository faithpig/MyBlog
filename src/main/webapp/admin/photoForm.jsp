    ...
    <div class="content">
       ...
       function subForm(){
			var form1 = document.forms[0];
       		var title = document.getElementById("p_name").value;
       ...
       <form name="example" method="post" action="<%=path%>/admin_addPhoto" enctype="multipart/form-data">
       	<label>名称：</label>
       	<input type="text" name="photo.name" value="" id="p_name"/>
       	<span id="title_say"></span>
       	<br/>
       	<br/>
       	<label>描述：</label>
       	<textarea rows="4" cols="30" name="photo.describe" id="p_describe" style="vertical-align: top;"></textarea>
       	<br/>
		<br />
