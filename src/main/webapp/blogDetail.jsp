...
<div id="mainbody">
  <div class="blogs">
    <div id="index_view">
      <h1 class="c_titile"><s:property value="blog.title"/></h1>
      <p class="box">发布时间：<s:date name="blog.createTime" format="yyyy-MM-dd" /><span></span>修改时间：<s:date name="blog.alterTime" format="yyyy-MM-dd" /></p>
      <ul><li><s:property value="blog.content" escape="false"/></li></ul>
